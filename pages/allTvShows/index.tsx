...
export const getStaticProps: GetStaticProps = async () => {
    const genres = await axios.get<IGenreProps>('https://api.themoviedb.org/3/genre/tv/list?api_key=fa73aa778f5176e841d79af58c2b5862');
    const response = []
    for (let i = 1; i <= 5; i++) {
        let teste = await axios.get<IMovieCategoryProps>(`
        https://api.themoviedb.org/3/discover/tv?api_key=fa73aa778f5176e841d79af58c2b5862&with_genres=${genres}&page=${i}`
        );
